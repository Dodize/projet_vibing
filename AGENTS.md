...
* **Database Schema:** When modifying the database model, you must update `DATABASE_SCHEMA_REPORT.md` accordingly.
* **Project Issues:** Follow instructions to manage `project_issues.md`: create an issue if it does not exist, and check it off once completed (only after explicit user confirmation).
